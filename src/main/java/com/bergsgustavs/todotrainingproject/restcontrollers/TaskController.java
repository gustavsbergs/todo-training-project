...
public class TaskController {
    ...
    public TaskDTO getTask(@PathVariable final Long id) throws Exception {
    ...
    public TaskDTO updateTask(@RequestBody final TaskDTO taskParams, @PathVariable Long id) throws Exception {
    ...
    public void deleteTask(@PathVariable final Long id) throws Exception {
